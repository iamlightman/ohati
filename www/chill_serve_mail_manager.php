...
$root_dir = __DIR__;
$db_file = file_exists($root_dir . '/db.php') ? $root_dir . '/db.php' : (file_exists($root_dir . '/../db.php') ? $root_dir . '/../db.php' : null);
if ($db_file) require_once $db_file;

// Safely load mail & SMS helpers
$mail_helper_file = file_exists($root_dir . '/mail_helper.php') ? $root_dir . '/mail_helper.php' : (file_exists($root_dir . '/../mail_helper.php') ? $root_dir . '/../mail_helper.php' : null);
$sms_helper_file  = file_exists($root_dir . '/sms_helper.php') ? $root_dir . '/sms_helper.php' : (file_exists($root_dir . '/../sms_helper.php') ? $root_dir . '/../sms_helper.php' : null);
