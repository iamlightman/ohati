                ...
                html = `
                    ...
                    <div class="form-group mb-16">
                        ...
                        <div style="display:flex; align-items:center; gap:16px; background:#F8FAFC; padding:12px; border-radius:14px; border:1px solid #E2E8F0;">
                            <div style="position:relative; width:64px; height:64px; border-radius:50%; overflow:hidden; border:2px solid var(--accent); flex-shrink:0; background:#E2E8F0;">
                            ...
                            <div style="flex:1;">
                                <div id="reg-avatar-status" style="font-size:0.78rem; font-weight:700; color:${hasAvatar ? '#10B981' : '#64748B'}; margin-bottom:6px;">
                                    ${hasAvatar ? '<i class="fa-solid fa-circle-check" style="color:#10B981;"></i> Profile Photo Loaded' : 'No profile image selected'}
                                </div>
                                <button type="button" class="btn btn-outline btn-sm" onclick="document.getElementById('reg-avatar-file').click()" style="font-size:0.75rem; padding:6px 12px;">
                                    <i class="fa-solid fa-camera" style="margin-right:4px;"></i> Choose Profile Photo
                                </button>
                    ...
                    <div class="form-group mb-16">
                        ...
                        <div style="position:relative; width:100%; height:130px; border-radius:14px; overflow:hidden; border:2px dashed var(--accent); background:linear-gradient(135deg, #0B1F3A 0%, #1B2B4B 100%); display:flex; align-items:center; justify-content:center; flex-direction:column; text-align:center; color:#FFF; margin-bottom:8px;">
                            <img id="reg-cover-preview" src="${coverSrc}" style="position:absolute; top:0; left:0; width:100%; height:100%; object-fit:cover; opacity:${hasCover ? '1' : '0.4'}; transition:all 0.3s ease;">
                            <div style="position:relative; z-index:2; padding:10px 16px; background:rgba(11,31,58,0.78); border-radius:12px; border:1px solid rgba(242,167,53,0.35); backdrop-filter:blur(4px); max-width:85%;">
                                <div style="font-family:'Fraunces',serif; font-size:1.05rem; font-weight:800; color:#FFFFFF; margin-bottom:2px;">
                                    <i class="fa-solid fa-image" style="color:var(--accent); margin-right:6px;"></i> Your Cover Image Here
                                </div>
                                <div style="font-size:0.72rem; color:#F1F5F9; margin-bottom:8px;">Upload & crop your official profile cover banner</div>
                                <button type="button" class="btn btn-primary btn-sm" onclick="document.getElementById('reg-cover-file').click()" style="padding:6px 16px; font-weight:800; font-size:0.75rem; border-radius:8px;">
                        ...
                        <div id="reg-cover-status" style="font-size:0.78rem; font-weight:700; color:${hasCover ? '#10B981' : '#64748B'}; text-align:center;">
                            ${hasCover ? '<i class="fa-solid fa-circle-check" style="color:#10B981;"></i> Cover Photo Loaded' : 'Click above to select and crop your cover image'}
                        </div>
                    </div>
